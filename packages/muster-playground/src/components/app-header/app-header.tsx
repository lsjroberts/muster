...
function changeLocation(search: string, hash: string) {
  const { location } = window;
  location.assign(`${location.origin}${location.pathname}?${search}#${hash}`);
}
